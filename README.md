...
1. Create App Page.
2. Set up Android signing (keystore, password, alias). Configure [scripts/settings.json](scripts/settings.json) for your project (signing directory, key alias, etc.), then see [scripts/Build-Android.md](scripts/Build-Android.md) for a step-by-step guide or [scripts/README.md](scripts/README.md) for utilities and CI/CD setup.
